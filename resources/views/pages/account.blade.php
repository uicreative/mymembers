    ...
    <div class="card card-padded">
        ...
        @if ( ! $user->subscribed('main'))
            <div class="jumbotron text-center">
                ...
                <a href="{{ url('subscribe') }}" class="btn btn-success btn-lg">Start Membership</a>
            </div>
        @else
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <form action="{{ url('account/subscription') }}" method="POST">
                        {!! csrf_field() !!} 
        ...
        <form action="{{ url('account/card') }}" method="POST" id="subscribe-form">
            {!! csrf_field() !!}
            ...
            <table class="table table-bordered table-striped table-hover">
                @foreach ($invoices as $invoice)
                    <tr>
                        ...
                        <td>{{ $invoice->total() }}</td>
                        <td class="col-xs-2 ">
                            <a href="{{ url('/account/invoices') }}/{{ $invoice->id }}" class="btn btn-primary btn-sm">Download</a>
                        </td>
                    </tr>
                @endforeach 
            </table>
        ...
        {{-- delete subscription --}}
        <form action="{{ url('/account/subscription') }}" method="POST" class="text-right">
            {!! csrf_field() !!}
